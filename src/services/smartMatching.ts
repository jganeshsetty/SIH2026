...
/**
 * ============================================================================
 * FARMORA SMART MATCHING ALGORITHM SERVICE
 * Calculates Haversine geospatial distances and multi-criteria matching scores
 * (Crop type, Quantity, Quality grade, Target Price, & Freight Distance).
 * ============================================================================
 */
 ...
 */
export function computeSmartMatchScore(crop: Crop | FPOBulkOffer, demand: BuyerDemand): MatchingResult {
  ...
  const totalScore = Math.round(
    cropScore * 0.25 + quantityScore * 0.2 + gradeScore * 0.2 + priceScore * 0.2 + locationScore * 0.15
  );
